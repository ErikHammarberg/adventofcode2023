...
class Day3Test {
    ...
    public void prepareTest() {
        String input = "..44..55";
        Day3 sut = new Day3();
        sut.prepareNumbers(input);
    }

    @Test
            public  void oneTest() {
        Day3 sut = new Day3();
        sut.prepareNumbers(example);
        var res = sut.extractNeigboor(example, false);
        assertEquals(4361l, res);
    }
    ...
    @Test
        ...
        Day3 sut = new Day3();
        sut.prepareNumbers(input);
        var res = sut.extractNeigboor(input, false);
    ...
    @Test
        ...
        Day3 sut = new Day3();
        sut.prepareNumbers(example);
        var res = sut.extractNeigboor(example, true);
        assertEquals(467835l, res);
    }
    ...
    public void two() {
        Day3 sut = new Day3();
        sut.prepareNumbers(input);
        var res = sut.extractNeigboor(input, true);
        System.out.println(res);
    }
